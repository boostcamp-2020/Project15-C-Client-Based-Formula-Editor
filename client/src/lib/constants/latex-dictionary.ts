...
export const LATEX_DICTIONARY = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        latex: 'Pleft( \\frac {mx_{ 2 }+nx_{ 1 }}{m+n},\\frac {my_{ 2 }+ny_{ 1 }}{m+n} \\right) ',
        title: '평면좌표의 내분점',
      },
      {
        latex: 'Mleft( \\frac {x_{ 1 }+x_{ 2 }}{2},\\frac {y_{ 1 }+y_{ 2 }}{2} \\right) ',
        title: '평면좌표의 중점',
      },
      {
        latex: 'Qleft( \\frac {mx_{2}-nx {1}}{m-n},\\frac {my{2}-ny_{1}}{m-n} \\right) ',
        title: '평면좌표의 외분점',
      },
    ],
  },
  {
    ...
    content: [
      ...
      { latex: 'y=mxpm rsqrt {m^{ 2 }+1} ', title: '원의 접선의 방정식' },
      {
        latex:
          '\\frac {x^{ 2 }}{a^{ 2 }}-\\frac {y^{ 2 }}{b^{ 2 }}=…uad left( a>b>0,k^{ 2 }=a^{ 2 }+b^{ 2 } \\right) ',
        title: '쌍곡선의 방정식',
  ...
  },
  {
    ...
    content: [
      {
        latex:
          'csc\\theta =\\frac { 1 }{ sin\\theta }, sec\\theta ={ 1 }{ cos\\theta } cot\\theta =\\frac { 1 }{ tan\\theta } ',
        title: '삼각함수의 역수관계',
      },
      {
        latex:
      ...
      { latex: 'sin2alpha =2sinalpha cosalpha ', title: '2배각의 공식' },
      {
        latex: 'cos2alpha =cos^{ 2 }alpha -sin^{ 2 }alpha =2cos^{ 2 }alpha -1=1-2sin^{ 2 }alpha ',
        title: '2배각의 공식',
      },
      {
        latex: 'tan2alpha =\\frac { 2tanalpha }{ 1-tan^{ 2 } {alpha}} ',
        title: '2배각의 공식',
      },
      { latex: 'sin3alpha=3sinalpha -4sin^{ 3 }alpha ', title: '3배각의 공식' },
      {
        latex: 'cos3alpha =4cos^{ 3 }alpha -3cosalpha ',
        title: '3배각의 공식',
      },
      {
        latex: 'sin^{ 2 }\\frac {alpha }{2}=\\frac {1-cosalpha }{2} ',
        title: '반각의 공식',
      },
      {
        latex: 'cos^{2}\\frac{alpha}{2}=\\frac{1+cosalpha}{2} ',
        title: '반각의 공식',
      },
      {
        latex: 'tan^{ 2 }\\frac {alpha }{2}=\\frac {1-cosalpha }{1+cosalpha } ',
        title: '반각의 공식',
      },
      {
        latex:
      ...
      {
        latex: 'sinalpha +sin\\beta =2sin\\frac {alpha +\\beta }{2}cos\\frac {alpha -\\beta }{2} ',
      ...
      {
        latex: 'cosalpha +cos\\beta =2cos\\frac {alpha +\\beta }{2}cos\\frac {alpha -\\beta }{2} ',
        title: '삼각함수의 합/차를 곱으로 변형',
      },
      {
        latex:
